...
public class FavoriteController {
	...
	public ResponseEntity<String> addFavorite(@PathVariable("houseId") Integer houseId, Principal principal) {
	...
	public ResponseEntity<String> removeFavorite(@PathVariable("houseId") Integer houseId, Principal principal) {
		User user = userService.findByUsername(principal.getName());
		House house = houseService.findById(houseId);
