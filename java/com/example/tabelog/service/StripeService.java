...
public class StripeService {
	...
	public String createStripeSession(String houseName, ReservationRegisterForm reservationRegisterForm,
		...
		String reservationDateString = reservationRegisterForm.getReservationDate()
				.format(DateTimeFormatter.ISO_LOCAL_DATE);
		String reservationTimeString = reservationRegisterForm.getReservationTime().toString();
		...
		SessionCreateParams params = SessionCreateParams.builder()
				...
				.setPaymentIntentData(
						SessionCreateParams.PaymentIntentData.builder()
								...
								.putMetadata("reservationDate", reservationDateString)
								.putMetadata("reservationTime", reservationTimeString)
